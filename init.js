...
/*
ДОБАВЛЕНИЕ div ЧЕРЕЗ ЯВАСКРИПТ

$('<div class="'+options.pagerWrp+'"/>').appendTo(wrapper);

СТРУКТУРА IF и ELSE

if(условие){ если условие ок}else{ если условие не ок}
*/